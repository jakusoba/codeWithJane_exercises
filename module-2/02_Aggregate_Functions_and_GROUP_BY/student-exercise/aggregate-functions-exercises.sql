...
SELECT round(gnp * 1000000/population, 0) AS gnp_per_capita
FROM country
WHERE population > 0
...
SELECT continent, SUM(surfacearea) as surface_area_per_continent
FROM country
GROUP BY continent
...
-- (highest avg population: 4017733.0000, "SGP")SELECT AVG(population), countrycode
