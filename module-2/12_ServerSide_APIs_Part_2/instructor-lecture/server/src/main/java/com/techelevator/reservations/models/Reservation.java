...
public class Reservation {
    ...
    @NotBlank(message = "The field `fullName` can't be blank!")
    private String fullName;
    
    @NotBlank(message = "The field `checkinDate` can't be blank!")
    private String checkinDate;
    @NotBlank(message = "The field `checkoutDate` can't be blank!")
